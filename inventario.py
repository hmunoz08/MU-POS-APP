...
import sqlite3
import pandas as pd
import os  # Adición necesaria para el manejo seguro de rutas locales en PC
...
def conectar_db():
    # REPARACIÓN PC OFFLINE: Obliga al sistema a buscar la base de datos real en la carpeta de ejecución
